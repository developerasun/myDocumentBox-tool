...
3. Create a branch and move to the branch with : git branch -b myBranch
4. Add changes, commit, and push to the <strong>branch</strong>
5. Github will automatically sense the push and let you know about the change like below
